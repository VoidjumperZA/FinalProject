...
public class ScoreHandler : MonoBehaviour {
    ...
    {
        Vector3 onScreenPosition = Camera.main.WorldToScreenPoint(GameManager.Hook.transform.position);
        Vector3 positionOffset = new Vector3(onScreenPosition.x + hookScoreXOffset, onScreenPosition.y + hookScoreYOffset, 0.0f);
